...
After setting up dotnet you can verify you are using the newer version by executing `dotnet --info` -- the version should be greater in the form 2.1.xxx, where the last three digits are 300 or higher.
```
>dotnet.exe --info
.NET Command Line Tools (2.1.300-preview1-007460)

Product Information:
 Version:            2.1.300-preview1-007460
...
Runtime Environment:
 ...
 OS Platform: Windows
 RID:         win10-x64
 Base Path:   F:\dotnet\sdk\2.1.300-preview1-007460\
...
__NOTE: [The version number scheme was changed](https://github.com/dotnet/designs/pull/29) during development, so you may have nightly preview builds that start with form `2.2.0-preview1`. These must be manually uninstalled from your machine or they will block access to thew newer builds. Newer builds for .NET Core 2.1 start with 2.1.300.__
